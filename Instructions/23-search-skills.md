---
lab:
    title: 'Create a Custom Skill for Azure AI Services'
    module: 'Module 12 - Creating a Knowledge Mining Solution'
---

# Create a Custom Skill for Azure AI Services

Azure AI Services uses an enrichment pipeline of cognitive skills to extract AI-generated fields from documents and include them in a search index. There's a comprehensive set of built-in skills that you can use, but if you have a specific requirement that isn't met by these skills, you can create a custom skill.
...
> **Note**: If you have previously completed the **[Create an Azure AI Services solution](22-azure-search.md)** exercise, and still have these Azure resources in your subscription, you can skip this section and start at the **Create a search solution** section. Otherwise, follow the steps below to provision the required Azure resources.
...
14. In the Azure portal, refresh the resource group and verify that it contains the Azure Storage account, Azure AI Services resource, and Azure AI Services resource.
...
In this exercise, you'll use the Azure AI Services REST interface to create these components by submitting JSON requests.
...
11. In the **create-search** folder, open **create-search.cmd**. This batch script uses the cURL utility to submit the JSON definitions to the REST interface for your Azure AI Services resource.
12. Replace the **YOUR_SEARCH_URL** and **YOUR_ADMIN_KEY** variable placeholders with the **Url** and one of the **admin keys** for your Azure AI Services resource.

    *You can find these values on the **Overview** and **Keys** pages for your Azure AI Services resource in the Azure portal.*
...
16. When the script completes, in the Azure portal, on the page for your Azure AI Services resource, select the **Indexers** page and wait for the indexing process to complete.
...
1. At the top of the blade for your Azure AI Services resource, select **Search explorer**.
...
1. In the Azure Portal, on the **Home** page, create a new **Function App** resource with the following settings:
    ...
    - **Resource Group**: *The same resource group as your Azure AI Services resource*
    - **Function App name**: *A unique name*
    - **Publish**: Code
    - **Runtime stack**: Node.js
    - **Version**: 14 LTS
    - **Region**: *The same region as your Azure AI Services resource*
...
7. In the **Test/Run** pane, replace the existing **Body** with the following JSON, which reflects the schema expected by an Azure AI Services skill in which records containing data for one or more documents are submitted for processing:
...
10. In the **update-search** folder, open **update-search.cmd**. This batch script uses the cURL utility to submit the updated JSON definitions to the REST interface for your Azure AI Services resource.
11. Replace the **YOUR_SEARCH_URL** and **YOUR_ADMIN_KEY** variable placeholders with the **Url** and one of the **admin keys** for your Azure AI Services resource.
...
15. When the script completes, in the Azure portal, on the page for your Azure AI Services resource, select the **Indexers** page and wait for the indexing process to complete.
...
To learn more about creating custom skills for Azure AI Services, see the [Azure AI Services documentation](https://docs.microsoft.com/azure/search/cognitive-search-custom-skill-interface).
